...
public class VehicleControllerInspector : Editor
	...
	public override void OnInspectorGUI ()
		...
		if (m_showAdvanced)
			...
			InspectorTools.PropertyField(serializedObject, "spinUpdateRate", "Spin Update Rate", "When to update the wheel's visual position and rotation.");
			...
			InspectorTools.PropertyField(serializedObject, "disableWheelHitCorrection", "Disable WheelHit Correction", "Uses a faster, less-accurate method for calculating the wheel's contact point. It affects the physics behaviour at high speeds.");
