...
public class VehicleStandardInputInspector : Editor
	...
	public override void OnInspectorGUI ()
		...
		EditorGUILayout.PropertyField(serializedObject.FindProperty("steerAxis"));
            ...
            //SerializedProperty propControlMode = serializedObject.FindProperty("ControlMode");
            //EditorGUILayout.PropertyField(propControlMode);
            //VehicleStandardInput.ControlMode controlmode = (VehicleStandardInput.ControlMode)propControlMode.enumValueIndex;
