...
public class TextureCanvas
	...
	Color32 GetAlphaBlendedPixel (Color32 dst){
		...
		pixel = new Color32((byte)(m_color.r * m_srcAlpha + dst.r * m_dstAlpha), (byte)(m_color.g * m_srcAlpha + dst.g * m_dstAlpha), (byte)(m_color.b * m_srcAlpha + dst.b * m_dstAlpha), (byte)(m_color.a * m_srcAlpha + dst.a * m_dstAlpha));
		return pixel;
	}
